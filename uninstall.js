...
const binp = path.join(cargoDir, "bin", "codemd");

if (fs.existsSync(binp)) {
  console.log("Uninstalling codemd...");
  exec(`cargo uninstall codemd`, (error, stdout, stderr) => {
    console.log(stdout);
    if (error || stderr) {
  ...
  console.log("codemd not found skipping!");
}
